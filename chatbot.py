...
# creating retriver
retriver=vector_store.as_retriever(search_type="mmr",search_kwargs={"k":k})
# getter all retrived text together
def getcontext(retrived_text):
    context=" ".join(doc.page_content for doc in retrived_text)
    return context
